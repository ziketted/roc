        ...
        <div class="row row-deck row-cards">
            <div class="col-12">
                <form method="POST" action="{{ route('garage.store') }}" class="card">
                    @csrf
                  <div class="card-body">
                    <h3 class="card-title">Veuillez enregistrer les informations d'un garage</h3>
                    <div class="row row-cards">
                      <div class="col-md-5">
                        <div class="mb-3">
                          <label class="form-label">Garage</label>
                          <input type="text" class="form-control"  placeholder="Designation du garage"
                                         value="" name="garage"><i class="fas fa-ebay"></i>
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-3">
                        <div class="mb-3">
                          <label class="form-label">Nom du gerant</label>
                          <input type="text" class="form-control" placeholder="Nom du gerant" value="" name="gerant">
                        </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder="Avenue / Quartier / Commune"
                                                 value="" name="adresse">
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3">
                                <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder="Ville" value="Kinshasa" name="ville">
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3">
                                <div class="mb-3">
                                  <label class="form-label">Téléphone </label>
                                  <input type="test" class="form-control" placeholder="Code Postal" name="phone">
                                </div>
                              </div>
                              <div class="col-sm-3 col-md-3">
                                <div class="mb-3">
                                  <label class="form-label">Code postal</label>
                                  <input type="test" class="form-control" placeholder="Code Postal" name="postal">
                                </div>
                              </div>
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="mb-3 mb-0">
                          ...
                          <textarea rows="5" class="form-control" placeholder="Description" name="apropos" value="Mike"></textarea>
                        </div>
                      </div>
                      <div class="col-md-4">
...
<!-- Libs JS -->
<script src="./dist/libs/dropzone/dist/dropzone-min.js?1674944402" defer></script>
<script>
    // @formatter:off
