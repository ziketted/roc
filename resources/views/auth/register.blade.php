        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-area text-center">
                    <h1 class="section-title">Inscrivez-vous sur votre compte</h1>
                ...
                <div class="account-login-inner">
                    <form method="POST" action="{{ route('register') }}" class="ltn__form-box contact-form-box">
                        ...
                        <label class="checkbox-inline">
                            ...
                            Je consens à ce que ROC traite mes données personnelles afin d'envoyer du matériel
                            marketing personnalisé conformément au formulaire de consentement et à la politique de
                            confidentialité.
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" value="">
                        ...
                        <div class="btn-wrapper">
                            <button class="theme-btn-1 btn reverse-color btn-block" type="submit">CRÉER UN
                                COMPTE</button>
                        </div>
                    </form>
                    <div class="by-agree text-center">
                        <p>En créant un compte, vous acceptez nos :</p>
                        <p><a href="#">CONDITIONS GÉNÉRALES &nbsp; &nbsp; | &nbsp; &nbsp; POLITIQUE DE
                                CONFIDENTIALITÉ</a></p>
